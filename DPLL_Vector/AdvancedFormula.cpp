...
char* AdvancedFormula::variables_assign_ptr = nullptr;
char* AdvancedFormula::flip_flag_ptr = nullptr;
...
void AdvancedFormula::initVariablesAssignAndFlipFlag(int variables_cnt) {
	...
	this->variables_assign_ptr = new char[n];
	this->flip_flag_ptr = new char[n];
